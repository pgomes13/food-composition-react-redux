...
// core components
import { Quote, Muted, Primary, Info, Success, Warning, Danger, Card, CardHeader, CardBody } from "../../components";
...
function _TypographyPage(props) {
    const { classes } = props;
    return (
        <Card>
...
const TypographyPage = withStyles(style)(_TypographyPage);
